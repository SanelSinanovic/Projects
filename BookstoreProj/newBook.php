...
<body>
    <div class="w3-container w3-blue-grey">
        ...
        <form action="newBook.php" method="POST" class="w3-container w3-sand">
            <fieldset> 
                <label> Title </label>
                ...
                <select class="w3-select" name="publisher">
                   ...
                   <select class="w3-select" name="authors[]" id="listAuSel">
                        ...
                        <input type="button" class="w3-button w3-teal w3-round-large" value="Remove author" onclick="removeAuthor()">

                        <label> Avaliable Author(s) </label>
                        <select class="w3-select" id="listAuAv">
                            ...
                            ?>
            <select>
            <input type="button" class="w3-button w3-teal w3-round-large" value="Add author" onclick="addAuthor()">
            </fieldset>
        ...
        <div class="container w3-sand">
            <?php
                ...
                {
                    if(!isset($_POST['title']) || !isset($_POST['isbn']) || !isset($_POST['publisher']) ||!isset($_POST['auSel']) ||
                    !isset($_POST['publicationDate']) || !isset($_POST['price']))
                    {
                    ...
                    $sql= "INSERT INTO book (ISBN, title, publicationDate, publisher_id, price) VALUES ('$isbn','$title', 
                    '$pubDate',$publisher, $price)";
                    ...
                    if($conn->query($sql) === TRUE)
                    {
                        ...
                        echo "Publisher's ID: $publisher<br>";
                        echo "Author's ID: $authors<br>";
                        echo "<hr>";
